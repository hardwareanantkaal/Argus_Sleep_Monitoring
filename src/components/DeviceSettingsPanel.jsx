  ...
  return (
    <section className="settings-panel-section">
      ...
      <div className="settings-controls-grid">
        ...
        <div className="setting-control-card" onClick={onOpenPlacementCheck}>
          ...
          <div className="control-card-info">
            ...
            <p className="control-desc">Inspect radar positioning & signal alignment score</p>
          </div>
          <button className="control-action-btn primary-action">
            <span>Run Check</span>
        ...
        <div
          className={`setting-control-card ${configMode ? "active-amber-border" : ""}`}
        ...
        >
          ...
          <button className={`control-action-btn ${configMode ? "amber-action" : "secondary-action"}`} disabled={updatingConfig}>
            <span>{updatingConfig ? "Updating..." : configMode ? "Exit Config" : "Start Config"}</span>
          </button>
        </div>
      </div>
    </section>
